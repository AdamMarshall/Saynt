...
/* end var */  
  {
	 ...
	 * $segments String   dynamic segment e.g. 'medium==referral'  [ use the same form as filters, see example.filter.php ]
	 * **********************************/
    ...
    if ($segments !== null) 
	{
			if (!is_int($segments))
			 {
			  $parameters['segment'] = 'dynamic::'.$this->processFilter($segments);
			 }
			else
			 {
